...
<form action="<?php echo "game.php?playername=$playernameGlobal"?>" method="post"> 
    <?php
    /*----------------------------
    ...
    -----------------------------*/
        if($_SERVER['REQUEST_METHOD'] === 'POST')
        {
            ...
            {
                $currentScore = $_REQUEST['scoreData'];
                ...
                if($result->num_rows > 0) 
                {
                    ...
                    if(!$isScoreGoodAllTime)
                    {
                        $isHighscoreAHighscore = "Sorry! Your score didn't make it to the top 10 leaderboard";
                    }
                }
            }
        }
        ?>
        <input type="hidden" id="scoreData" name="scoreData", value="0">
        ...
        <div class="gamePage">
            <div class="game">
                <div class="gameNavbar">
                    ...
                    <div class="deathContainer">
                            ...
                            <h2 id="finalScore"></h2>
                            <button type="button" class="gameSubmitButton" onClick="window.location.reload(false);">Start over</button>                  
                        </div>
                </div>
                <!-- Game -->
                <div class="container">
                    <div class ="center">
                        <!-- To show when player dies -->
                        <!-- Actual game - canvas -->
            ...
            <div class="gameProfile-andButtons-Container">
                ...
                <div class="gameButtons">
                    <button type="button" class="showHideKeysBtn" id="showHideKeysBtn"></button>
                    <button type="button" class="showHelpBtn" id="showHelpBtn">Help</button>
                    <button type="button" class="highscoreBtn" id="allTimeHighscorePopUpBtn">Highscores</button>
                    <input type="submit" class="submitScoreBtn" name="knap" value="Submit" id="submitScoreBtn"<?php echo $buttonCreate ?>>
                </div>
            </div>  
    ...
    <script type="text/javascript" src="FarmingGame/game.js" defer></script>
    <script type="text/javascript" src="FarmingGame/noscroll.js" defer></script>
