...
<form action="game.php" method="post"> 
    <?php
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST')
        {
            ...
            if($_REQUEST['knap'] == "Submit")
            {
                ...
                //Tjekker om score er høj nok til at komme på alltime highscores
        ...
        <div class="gamePage">
            <div class="game">
                ...
                <div class="farmingGame">
                    <!-- Container til canvas, knapper og beskeder + helper -->
                    <div class="container">
                        <div class ="center">
                            <!-- Actual game - canvas -->
    ...
    <script type="text/javascript" src="FarmingGame/gameInside.js"></script>
